...
- **DURUM: COMMIT+PUSH `b8c1613` (Faz 4 + review pass) + 075/076 APPLY BEKLİYOR.** Sıradaki: smoke (signed URL inline render? Content-Disposition; logo/font/drift/idempotent; arşiv fail→warning toast) + Faz 6 (077 accept→sipariş; serviceArchiveQuotePdf orada reusable — V7-A5 recover/generate).
