...
**⚠️ Araç notu:** bu koşuda semgrep+gitleaks sandbox `Bash` izni reddiyle ÇALIŞAMADI (`dangerouslyDisableSandbox` dahil) → mekanik SAST/secret atlandı; bulgular elle+hedefli-grep. Tam kapsama için izinli ortamda koşturulmalı. **Tüm denetim bulguları (O/D/Nit) kapandı.**
