...
## Son Tamamlanan İş — 2026-06-04 (**Satın Alma Siparişi (Yeni) — ürün seçilince birim fiyat + KDV otomatik gelmiyor [FONKSİYONEL bug]**)
...
- **DURUM: COMMIT/PUSH kullanıcı onayı bekliyor.** ⚠️ **Ekran görüntüsü #2 GÖRÜLMEDİ** — submit validasyon hatasıysa bu fix kapatır; başka bir hataysa kullanıcı bildirmeli. Plan: `~/.claude/plans/stok-r-nler-sayfas-n-detayl-calm-charm.md` (PO yeni form içeriğiyle güncel).
