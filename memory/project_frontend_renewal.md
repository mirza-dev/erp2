...
| B | Component Kütüphanesi | DataTable(+onRowClick+minWidth+rowStyle+`.row-reveal`), Card, Badge VAR; uygulandı: Vendors+PO+Customers+Orders+Quotes+3 settings tablosu (`c6f46fc`/`931c62d`/`64af65d`/`024c2d8`/`cdb5be3`/`dceb9a8`). Premium light theme entegre (`f550e83`). Sıradaki: products/page.tsx → Input/PageHeader/SectionHeader/NavLink/Stat + drawer/form AÇIK |
