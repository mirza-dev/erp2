...
| B | Component Kütüphanesi | DataTable(+onRowClick+minWidth), Card, Badge VAR; uygulandı: Vendors + PO + Customers (`c6f46fc`/`931c62d`/`64af65d`). Premium light theme token'ları entegre (`f550e83`). Input/PageHeader/SectionHeader/NavLink/Stat + kalan ~21 liste + drawer/form AÇIK; OrdersClient için DataTable `rowStyle` gerek |
