...
**Tek kaynak:** `docs/brand/roven-marka-rehberi.md` (§1.5 **dürüstlük tablosu: vaat ≤ canlı** — AI/Paraşüt koşullu yazılır; §2 "yapay zeka" ≠ "AI" kuralı; §4.4 üç ayrı mavi: UI accent `#58a6ff/#123f73`, e-posta `#123f73` [2026-09-18: Roven mavisine hizalandı], belge rengi = **müşterinin** rengi, Roven'ın değil → artık kodda sabit DEĞİL: `company_settings.document_accent_color` (mig.112, varsayılan `#0072BC` = PMT) · Ayarlar › Firma › Belge Rengi) · `docs/brand/isim-arastirmasi.md` (roven.com/.com.tr DOLU — .com.tr Roven Çikolata; **`tekakis.com/.com.tr/.tr` MÜSAİT**, "tek akış"; `rovenerp.com` müsait; "Raven Software Lab" sesteş ERP satıcısı; TÜRKPATENT/TMview sorgusu **kullanıcı adımı**).
