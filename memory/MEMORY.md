...
- [project_brand.md](project_brand.md) — **Marka + pazarlama (2026-09-18)**: geniş KOBİ · rehber §1.5 vaat ≤ canlı · isim Roven / `rovenerp.com` · logo Akış Altıgeni · **fiyat: kurulum + yıllık bakım** (`fiyatlandirma-modeli.md`) · landing huni (#fiyat, #iletisim, `/api/contact`) · SEO + `/rehber` · `satis-kiti.md`
- [current_focus.md](current_focus.md) — **Aktif sprint, son tamamlanan işler ve sonraki adımlar** — her tur ayrı `##` bölümü. En son (2026-09-18): iç e-posta accent Roven mavisi `#123f73` (marka notu b). 2026-09-17: kapanış envanteri A1–A7 kapandı — 409 FK · PO print guard · gerçek-DB kapısı · E2E 94→123 · `revalidateTag "max"` SWR → `"immediate"`.
