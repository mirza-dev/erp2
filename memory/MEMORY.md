...
- [current_focus.md](current_focus.md) — Son: Teklif V7 Faz 3 header iskonto IMPLEMENT (3799 test, COMMIT+migration APPLY BEKLİYOR) — discount_amount KDV öncesi matrah + V3-A6 draft guard RPC + kritik hydrate; önceki: Faz 2 (afe936b)
...
- [project_quotes.md](project_quotes.md) — Teklif modülü: V7 master plan (56 düzeltme); Faz 1a/1b/2 ✅, **Faz 3 header iskonto ✅** (3799 test, COMMIT+migration APPLY BEKLİYOR); sıradaki Faz 5 (072) / Faz 4 (PDF arşiv)
