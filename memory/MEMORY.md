...
- [current_focus.md](current_focus.md) — **Aktif sprint + son işler** — her tur ayrı `##` bölümü. En son (2026-09-18): belge vurgu rengi firma ayarına taşındı (`document_accent_color`, mig.112) + marka dalı main'e birleşti (logo görünür oldu). Önce: iç e-posta accent `#123f73`.
