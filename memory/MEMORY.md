...
- [current_focus.md](current_focus.md) — **Aktif sprint, son tamamlanan işler ve sonraki adımlar** — her tur ayrı `##` bölümü. En son (2026-09-17): onboarding turu (8 adım rehber · CTA · Sistem Durumu · davet · pilot; PR #1) + A1–A7 kapanış envanteri (E2E 123 · test:integration · cache "immediate").
