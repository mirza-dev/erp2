...
- [current_focus.md](current_focus.md) — **Aktif sprint, son tamamlanan işler ve sonraki adımlar** — her tur ayrı `##` bölümü. En son (2026-09-12): MEMORY.md taşması + kapı kör noktası · `npm audit` 9→0 · Strix bırakıldı.
