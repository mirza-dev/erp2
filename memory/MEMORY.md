...
- [project_brand.md](project_brand.md) — **Marka (2026-09-16)**: geniş KOBİ konumu · `docs/brand/roven-marka-rehberi.md` (§1.5 vaat ≤ canlı) · isim raporu (tekakis.com MÜSAİT; roven.com.tr çikolatacıda) · **logo: Akış Altıgeni UYGULANDI** (4 kaynak kilitli) · OG statik `public/og.png`
