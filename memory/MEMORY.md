...
- [current_focus.md](current_focus.md) — Son: Teklif V7 **Faz 4 PDF Arşiv** (dondurulmuş HTML snapshot) **+ Bulgular 1.+2. review tur**. 2. tur: B1 müşteri adresi resmi belgeye (4 nokta: QuoteData/BILINGUAL_LABELS/QuoteDocument/buildQuoteDataFromDetail/QuoteForm önizleme — advisor drift trap), B2 sent silme→draft-only (immutable arşiv), B3 archive-fail toast honest, B4 graceful 404 kabul, B5 doc hizalama. 3960 test, **COMMIT+PUSH BEKLİYOR + 075/076 APPLY BEKLİYOR**; önceki: Revizyon Zinciri (074 ✅)
...
- [project_quotes.md](project_quotes.md) — Teklif modülü: V7 master plan; Faz 1a/1b/2/3 ✅ + Faz 5 numara (073) ✅ + Revizyon zinciri (074) ✅ + **Faz 4 PDF Arşiv** (075-076, dondurulmuş HTML snapshot) + **Bulgular 1.+2. review tur** (2. tur: adres resmi belgeye, sent silme→draft-only, honest toast; 3960 test, COMMIT+PUSH+075/076 APPLY BEKLİYOR); ERTELENEN: sig rename, **quotes audit katmanı** (modül-geneli), Puppeteer/binary-PDF (frozen HTML seçildi); sıradaki Faz 6 (accept→sipariş, 077)
