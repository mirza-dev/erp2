-- ============================================================
-- Migration 035 — Atomic Quote Write RPCs
-- Teklif create/update işlemlerini tek transaction'a alır.
-- dbCreateQuote ve dbUpdateQuote bu fonksiyonları çağırır.
-- ============================================================

create or replace function create_quote_with_lines(
    p_header jsonb,
    p_lines  jsonb   -- jsonb array
)
returns uuid
language plpgsql
as $$
