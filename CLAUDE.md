...
- **Migration 074:** `revision_no`(default 1)/`root_quote_id`(FK, idx) kolonları + status CHECK `+revised` (034 deseni idempotent) + RPC. **APPLY BEKLİYOR.**
