...
**Son tamamlanan iş:** Teklif V7 **Faz 7 — Not Şablonları (note_templates)** — migration 079, QuoteForm picker + admin CRUD, 4094 test, **COMMIT+PUSH EDİLDİ (3551302) · migration 079 APPLY BEKLİYOR** (V7 master-plan TAMAMLANDI)
