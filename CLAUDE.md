...
- **Migration 090 APPLY (Supabase):** user_note tipi + due_date/created_by kolonları. Uygulanana dek '✎ Not' kaydı DB CHECK hatasıyla 500 döner (UI hata mesajı gösterir, başka akış etkilenmez).
