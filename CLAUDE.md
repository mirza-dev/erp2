...
**Son tamamlanan iş:** Teklif V7 **Faz 7 — Not Şablonları (note_templates)** + Bulgular 1.+2.tur — migration 079, QuoteForm picker + admin CRUD, 4098 test, **COMMIT+PUSH EDİLDİ · migration 079 APPLY EDİLDİ ✅** (V7 master-plan TAMAMLANDI)
