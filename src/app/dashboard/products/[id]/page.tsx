    ...
    const handleSave = async () => {
        ...
        try {
            const body: Record<string, unknown> = {
                ...
                sub_category: editForm.subCategory || undefined,
                product_family: editForm.productFamily || undefined,
                product_type: editForm.productType,
                sector_compatibility: editForm.sectorCompatibility || undefined,
                industries: editForm.industries || undefined,
                use_cases: editForm.useCases || undefined,
                material_quality: editForm.materialQuality || undefined,
                origin_country: editForm.originCountry || undefined,
                production_site: editForm.productionSite || undefined,
                standards: editForm.standards || undefined,
                certifications: editForm.certifications || undefined,
                unit: editForm.unit || undefined,
                warehouse: editForm.warehouse || undefined,
                preferred_vendor: editForm.preferredVendor || undefined,
                lead_time_days: editForm.leadTimeDays ? Number(editForm.leadTimeDays) : undefined,
                weight_kg: editForm.weightKg ? Number(editForm.weightKg) : undefined,
                price: editForm.price ? Number(editForm.price) : undefined,
                currency: editForm.currency || undefined,
                cost_price: editForm.costPrice ? Number(editForm.costPrice) : undefined,
                product_notes: editForm.productNotes || undefined,
                min_stock_level: editForm.minStockLevel ? Number(editForm.minStockLevel) : undefined,
                daily_usage: editForm.dailyUsage ? Number(editForm.dailyUsage) : undefined,
                reorder_qty: editForm.reorderQty ? Number(editForm.reorderQty) : undefined,
            };
