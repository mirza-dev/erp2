            ...
            <div id="quote-document" style={docStyle}>
                ...
                <div className="doc-brand-bg doc-no-break" style={headerBandStyle}>
                    ...
                    <div style={{ flexShrink: 0 }}>
                        {data.logoSrc
                            ? <img src={data.logoSrc} alt="logo" style={{ width: "72px", height: "72px", objectFit: "contain", background: "white", borderRadius: "6px", padding: "4px" }} />
                            : <div style={{ width: "72px", height: "72px", background: "rgba(255,255,255,0.15)", borderRadius: "6px", display: "grid", placeItems: "center" }}>
