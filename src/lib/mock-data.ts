...
export interface Product {
    ...
    quoted: number;          // total qty in draft/pending_approval orders
    promisable: number;      // available_now - quoted (can be negative)
    incoming: number;        // total pending purchase commitments
