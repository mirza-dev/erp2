...
export const AI_IMPORT_OPERATIONS = [
    ...
    },
    {
        ...
        shortTitle: "Doküman ekle",
        description: "Sertifika, uygunluk belgesi, test raporu veya ürün dosyalarını ürüne eşleştirir.",
        evidenceHint: "Hedef ürün adı/SKU ve belge tipi kanıtı aranır.",
        safetyNote: "Sertifika/standart eksikleri bloklayıcı değildir; bilgi uyarısı olarak kalır.",
